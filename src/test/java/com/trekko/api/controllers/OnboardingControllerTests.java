...
public class OnboardingControllerTests {
    ...
    @Test
    public void getAboutText() throws Exception {
        this.mockMvc.perform(get("/onboarding/texts/about"))
                .andExpect(status().isOk());
    }

    @Test
    public void getGoalText() throws Exception {
        this.mockMvc.perform(get("/onboarding/texts/goal"))
                .andExpect(status().isOk());
    }
}
